...
Prerequisites:
    ...
    client_configuration:
        title: Client-configuration setup with Vipps.
...
The login process:
    start_authorization:
        ...
        endpoints:
            - /oauth2/auth
        descriptions:
            /oauth2/auth: Start authorization against Vipps login by redirect the user to Vipps authorization page. The user is sent with state, redirect URI and the scopes you already selected as necessary when login to your website.
        modes:
            /oauth2/auth: GET
        responses: true
        keywords:
...
Important to implement:
    access_information:
        title: Collect information using access token
